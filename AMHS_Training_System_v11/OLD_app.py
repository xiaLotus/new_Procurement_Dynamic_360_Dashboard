...
# 4. 替換原有的 PATCH /api/employee/<emp_id>/day-num/<int:day_num> (加入 lock)
@app.route('/api/employee/<emp_id>/day-num/<int:day_num>', methods=['PATCH'])
def patch_employee_day_num(emp_id, day_num):
    err = require_login()
    if err: return err
